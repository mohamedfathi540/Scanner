...
1. "عصعص" vs "ناسور": Read carefully. Do NOT automatically assume "ناسور" is "عصعص". If it clearly says "ناسور يو", extract it as "ناسور يو".
...
3. **Master List Match**: Find the EXACT match in the product list. If it is completely missing, construct it exactly as written according to Rule 9. If unsure between two similar products, prefer the one that uses all the text you read from both lines.
